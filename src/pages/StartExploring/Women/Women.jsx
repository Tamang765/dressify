...
const Women = () => {
  ...
  const firstObject = filterWomen[0];
  ...
  const [active, setActive] = useState(Array(Newarrivalsdata.length).fill(false));
  ...
  return (
    <div className="container women">
      ...
      <br />
      <button className=" show-me d-flex m-auto justify-content-center" >
            View  More
      </button>
    </div>
  );
